...
| `{project}/docs/requirements.md` がある & `wireframe.html` がない | Phase 2 へ |
| `{project}/wireframe.html` がある & `design-draft.html` がない | Phase 3 へ |
| `{project}/design-draft.html` がある | Phase 4 へ |
...
出力: `{project}/wireframe.html`

## Phase 3（ビジュアルデザイン — デザイナー）
以下を必ず読み込んでから開始する:
- `{project}/docs/context.md`
- `{project}/docs/requirements.md`
- `{project}/wireframe.html`
