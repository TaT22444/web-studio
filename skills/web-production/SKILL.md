...
- `{project}/docs/DESIGN.md`（デザイン方向性ドラフト — v1。設計方向の対話結果を含む）
...
- `DESIGN.md` はフェーズ間のデザイン情報の橋渡し役。Phase 3 で v1 → v2 に更新し、Phase 4 で SSoT として参照する。Phase 3 内のフィードバックで v2.x として追記更新してよい。Phase 4 突入前の最新版が SSoT となる。
